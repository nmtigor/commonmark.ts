...
export declare function getAllStateNodes(
  stateNodes: Iterable<AnyStateNode>,
): Set<AnyStateNode>;
export declare function getStateValue(
...
export declare function getCandidates<TEvent extends EventObject>(
...
export declare function formatTransitions<
  TContext extends MachineContext,
  TEvent extends EventObject,
>(
  stateNode: AnyStateNode,
): Map<string, TransitionDefinition<TContext, TEvent>[]>;
export declare function formatInitialTransition<
  TContext extends MachineContext,
  TEvent extends EventObject,
>(
  stateNode: AnyStateNode,
...
export declare function getInitialStateNodes(
  stateNode: AnyStateNode,
): Set<AnyStateNode>;
/**
 ...
 */
export declare function getStateNodeByPath(
  stateNode: AnyStateNode,
...
export declare function transitionNode<
  TContext extends MachineContext,
  TEvent extends EventObject,
>(
  stateNode: AnyStateNode,
  stateValue: StateValue,
  snapshot: MachineSnapshot<TContext, TEvent, any, any, any, any, any, any>,
  event: TEvent,
...
export declare let executingCustomAction:
 ...
 */
export declare function resolveStateValue(
  rootNode: AnyStateNode,
  stateValue: StateValue,
): StateValue;
export {};
